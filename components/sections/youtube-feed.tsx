        ...
        <section id="videos" className="py-16 md:py-24 bg-background relative border-t border-border">
            <div className="container mx-auto px-4">
                        ...
                        <FadeIn key={index} delay={index * 0.1}>
                            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden border border-border bg-card group shadow-lg">
                                <iframe
                                    ...
                                    loading="lazy"
                                />
                                {/* Overlay for style before play */}
                                <div className="absolute inset-0 border border-border rounded-2xl pointer-events-none group-hover:border-red-500/50 transition-colors duration-300" />
                            </div>
                        </FadeIn>
                    ))}
                </div>
                ...
                <div className="mt-16 text-center">
                    <Button
                        size="lg"
                        className="bg-red-600 text-white hover:bg-red-700 font-bold uppercase tracking-wider h-14 px-10 gap-3 shadow-md"
